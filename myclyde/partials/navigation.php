      ...
      <div class="relative flex items-center justify-between h-16">
        <div class="flex items-center px-2 lg:px-0">
          <a class="flex-shrink-0" href="#">
            <img class="block lg:hidden h-12 w-auto" src="<?= BASE_PATH ?>/assets/images/myclydelogo.png" alt="Logo">
            <img class="hidden lg:block h-8 w-auto" src="<?= BASE_PATH ?>/assets/images/myclydelogo.png" alt="Logo">
          </a>
