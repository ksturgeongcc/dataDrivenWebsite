...
<section class="pt-20 lg:pt-[20px] pb-10 lg:pb-20 bg-[#F3F4F6]">
   <div class="container items-center flex flex-col">
    <?php if($admin == 1) : ?>
      <button onclick="window.location.href='addEvent'" class="mb-10 bg-blue-500 w-fit hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
      Add Event
    </button>
    <?php endif ?>
        ...
        <?php while ($events->fetch()): ?>
         ...
         <div class="w-full md:w-1/2 xl:w-1/3 px-4">
            <div class="bg-white rounded-lg overflow-hidden mb-10">
               <img
                  src="<?= BASE_PATH ?>assets/images/events/<?= $img ?>"
                  alt="image"
                  class="w-full"
                  />
